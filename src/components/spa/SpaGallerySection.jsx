...
const SpaGallerySection = () => {
  ...
  return (
    <SectionContainer id="spa-gallery">
      <ContentWrapper>
        <Overline>{t('spa.gallery.badge', 'Gallery')}</Overline>
        <Title>{t('spa.gallery.title', 'Gallery')}</Title>
        <Subtitle>
          {t('spa.gallery.subtitle', 'The atmosphere of relaxation and beauty at KAIF SPA')}
        </Subtitle>
