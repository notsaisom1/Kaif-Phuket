...
const BarMenuSection = () => {
  ...
  const activeCategoryData = barCategories.find(c => c.key === activeCategory);
  ...
  return (
    <SectionContainer id="bar-menu">
      <ContentWrapper>
        <Overline>{t('bar.hero.badge', 'Our Bar')}</Overline>
        <Title>{t('bar.hero.title', 'Bar Menu')}</Title>
        <Subtitle>
          {t('bar.hero.subtitle',
            'From signature cocktails and premium spirits to freshly squeezed juices and fitness drinks')}
        </Subtitle>
